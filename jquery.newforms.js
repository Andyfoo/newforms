		...
		replace_input_text : function() {
			...
			inputs.each(function(i) {
				...
				if (input.attr("ntype") == "number") {
					...
					//使用了laydate
					//使用时请加载<script language="javascript" src="/js/ui/lay/laydate/laydate.js"></script>
					...
					cale_config.done = function() {
						input.blur();
						input.change();
					}
					cale_config.trigger = 'focus';
					cale_config.elem='input[name="'+input.attr('name')+'"]';
					laydate.render(cale_config);
